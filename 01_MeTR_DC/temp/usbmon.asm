...
;* Date/Time created: Wed Mar 25 10:28:19 2026                                *
;******************************************************************************
...
;	acp6x -q -D_FAR_RTS=1 --large_model=3 --version=6701 -m --i_output_file C:\Users\W10\AppData\Local\Temp\TI3052_2 --template_info_file C:\Users\W10\AppData\Local\Temp\TI3052_3 --object_file usbmon.obj --opt_shell 9 usbmon.c -as -k -mr1 -ml3 -q -fstemp -fftemp -mv6701 usbmon.c 
	.sect	".text"
	.global	_InitUSBMon
