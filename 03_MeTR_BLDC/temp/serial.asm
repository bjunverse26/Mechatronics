...
;* Date/Time created: Mon May 25 14:24:06 2026                                *
;******************************************************************************
...
;	acp6x -q -D_FAR_RTS=1 --large_model=3 --version=6701 -m --i_output_file C:\Users\W10\AppData\Local\Temp\TI12488_2 --template_info_file C:\Users\W10\AppData\Local\Temp\TI12488_3 --object_file serial.obj --opt_shell 9 serial.c -as -k -mr1 -ml3 -q -fstemp -fftemp -mv6701 serial.c 
	.sect	".text"
	.global	_InitUART
